...
#include <SPI.h>  // Used by USB stack, not for SD
#include <WiFi.h>
#include <WebServer.h>
#include <Wire.h>
#include <U8g2lib.h>
...
// ---------------- General Variables ----------------
String vers = "3D Printer File Upload v1.1";
int UploadStatus = 0;
...
String WIFI_SSID = "APWifi3";
String WIFI_PASSWORD = "R3db0x123!";
...
bool init_sdmmc() {
  ...
  host.max_freq_khz = 40000;  // ~20 MHz, stable
  ...
  Serial.println("Mounting SDMMC (4‑bit)...");
  ...
  Serial.println("SDMMC mounted OK (4‑bit)!");
